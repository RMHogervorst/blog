...
# Inspiration
The Hitchhiker's Guide to the Galaxy (HHGTTG for short) is a series of scifi novels^[and radio plays and a TV-show and a movie, but we don't talk about the movie and TV-series, it's like jar-jar binks. The radio plays are amazing though.] about the last surviving man, Arthur Dent, after the destruction of earth. And I love it.
...
![Arthur Dent is confused (words connected to Arthur)](/post/2018-07-24-arthur-blinked-ford-shrugs-displaying-words-as-graph_files/arthur_is_confused.png){width=80% height=80%}
...
```{r, include=FALSE}
HHGTTG <- readr::read_rds("~/Documents/actief/Projecten/hhgttg/data/HHGTG.RData")
```
