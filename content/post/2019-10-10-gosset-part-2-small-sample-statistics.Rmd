...
share_img: /post/2019-10-10-gosset-part-2-small-sample-statistics_files/cheers-839865_640.jpg
---
...
Simulation was the key to to achieve beer dominance. 

# 'Scientific' Brewing at scale in the early 1900s

![Beer bottles cheers](/post/2019-10-10-gosset-part-2-small-sample-statistics_files/cheers-839865_640.jpg)
...
![Yes that is the wikipedia portret of William Gosset!](/post/2019-10-10-gosset-part-2-small-sample-statistics_files/my_room.jpg) 
...
have their own specialised names^[from the wikipedia article I found the words: _wort_=the sugary liquid, _mashing_ = mixing malted barley with hot water, _liquor_ = hot water with sugar in it, _grist_ =crushed malt, _sparging_ = washing of grains, _lautering_ = seperation of wort with grain itself] , which are different in all languages. So I will
...
*Grain, Barley, transforming into malt, as seen here.*  ![Malt and grain, detail of individual sprouted malt](/post/2019-10-10-gosset-part-2-small-sample-statistics_files/malt_and_grain.jpg)

Remember that we use the barley for its starch, which is converted into sugar. Sugar is converted by yeast into alcohol. Therefore the amount of sugar in the mixture determines the maximum ammount of alcohol the
yeast can create. Higher alcohol content keeps the beer for longer
periods, but it also changes the taste of the beer. 
The Guiness brewers wanted consistent taste and consistent alcohol levels. 

Too high alcohol levels would increase the tax Guiness was paying the British
...
![Barley in the sun](/post/2019-10-10-gosset-part-2-small-sample-statistics_files/barley.jpg)
...
within 0.5 degree of the real value)? And every sample takes time and destroys a that sample from the barrel. 


## Simulation

![Malt, green, a handful of green malt](/post/2019-10-10-gosset-part-2-small-sample-statistics_files/320px-Grünmalz.jpg)
...
By simulating these draws from one barrel, they generalized this patern to
what would happen if they sampled from the all of the barrels.

And that is what I will show in R code. 

So we are talking about sampling, but maybe not this kind of sampling... ![Randy Marshal sampling beer and wine (South Park)](/post/2019-10-10-gosset-part-2-small-sample-statistics_files/randy_sampling.gif)
...
10 out of 11 sucesses, 10/11 gives us a probability of approximately 0.909.
...
The brewers were happy, Gosset was too. But he realised there must be a
